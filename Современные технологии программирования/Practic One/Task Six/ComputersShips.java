...
public class ComputersShips extends Ships{
    static final List<ComputersShips> shipsList = new ArrayList<>();

    static int countOfBattleShip;
    static int countOfCruiser;
    static int countOfDestroyer;
    static int countOfSubmarine;
    static int countAliveShip;
